...
> until it has run on a real Pico 2. See [experiments/](./experiments/). The
> [Scope](#scope) list below is still what this repository means to poke at,
> not a summary of what it has covered.
