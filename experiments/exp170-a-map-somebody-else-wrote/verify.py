...
EXPECTED = {
    ...
    "mc-good": ("ctap", "CTAP2_ERR_OPERATION_DENIED"),
    ...
    "mc-many-algs": ("ctap", "CTAP2_ERR_OPERATION_DENIED"),
}
...
def main():
    ...
    if not any("having understood the request" in l for l in lines):
        problems.append("nothing in the log distinguishes a refusal from a failure to read")
