...
"""The origin the browser half needs, and the sink its results go into.
    ...
    python3 serve.py            # http://localhost:8192

Lifted from exp192's own predecessor, [exp174](../exp174-a-deadline-nobody-mentioned/),
unchanged but for the port. Fifty lines is the size at which copying is cheaper
than sharing, and the two experiments must be able to drift: exp174's page is a
subject and this one's is an instrument.
