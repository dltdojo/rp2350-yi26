...
// UP_MODE and WAIT_FOR_USER, from build.rs and EXP171_UP.
include!(concat!(env!("OUT_DIR"), "/exp171_config.rs"));
...
const PRODUCT: &str = "exp171 a credential nobody asked for";
...
async fn main(spawner: Spawner) {
    ...
    log!("exp171 a credential nobody asked for");
    Timer::after(PACE).await;
    ...
    Timer::after(PACE).await;
    log!("  CTAP2: getInfo and makeCredential. ES256, self-attested.");
    Timer::after(PACE).await;
