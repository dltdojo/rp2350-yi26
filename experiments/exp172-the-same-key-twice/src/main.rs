...
// UP_MODE and WAIT_FOR_USER, from build.rs and EXP172_UP.
include!(concat!(env!("OUT_DIR"), "/exp172_config.rs"));
...
const PRODUCT: &str = "exp172 the same key twice";
